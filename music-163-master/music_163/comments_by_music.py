...
if __name__ == '__main__':
            ...
            for i in tqdm(list(musics)[:20]):
                ...
                try:
                    ...
                    if comments['total'] > 0:
                        ...
                        sql.insert_comments(my_music_id, comments['total'], a, connection0)
    ...
    music_before=[int(i['MUSIC_ID']) for i in music_before]
    sort=Counter(music_before)
    music=sort.keys()
    ...
    t1 = threading.Thread(target=save_comments, args=(music, True, connection1))
